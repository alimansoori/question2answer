 ...
 * modified. Set $silent to true to not mark the question as edited. Reports event as appropriate. See /ilya-include/app/posts.php
 ...
 * /ilya-include/app/posts.php for a higher-level function which is easier to use.
 * @param $oldquestion
 * @param $oldclosepost
 ...
 * reports. See /ilya-include/app/posts.php for a higher-level function which is easier to use.
 * @param $oldquestion
 * @param $status
 * @param $userid
 * @param $handle
 ...
 * IDs and paths for all answers and comments. See /ilya-include/app/posts.php for a higher-level function which is easier to use.
 * @param $oldquestion
 * @param $categoryid
 * @param $userid
 * @param $handle
 ...
 * to true to not mark the question as edited. Handles unindexing and event reports. See /ilya-include/app/posts.php for a

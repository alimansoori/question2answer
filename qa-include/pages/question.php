...
if ($microdata) {
	...
	$ilya_content['html_tags'] .= ' itemscope itemtype="https://schema.org/QAPage"';
	$ilya_content['wrapper_tags'] = ' itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"';
}

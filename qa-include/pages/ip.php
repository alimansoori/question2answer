...
$blockable = ilya_user_level_maximum() >= QA_USER_LEVEL_MODERATOR; // allow moderator in one category to block across all categories
	...
	elseif ($blockable) {
		...
		if (ilya_clicked('dohideall') && !ilya_user_maximum_permit_error('permit_hide_show')) {
			...
			foreach ($postids as $postid)
				ilya_post_set_status($postid, QA_POST_STATUS_HIDDEN, $userid);

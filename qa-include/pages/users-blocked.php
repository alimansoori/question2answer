...
$userSpecCount = ilya_db_selectspec_count(ilya_db_users_with_flag_selectspec(QA_USER_FLAGS_USER_BLOCKED));
$userSpec = ilya_db_users_with_flag_selectspec(QA_USER_FLAGS_USER_BLOCKED, $start, $pagesize);
...
if (ilya_get_logged_in_level() < QA_USER_LEVEL_MODERATOR) {

...
function qa_db_table_definitions()
{
	...
	*/
	...
	/*
		...
		* See box at top of /ilya-include/app/recalc.php for a list of redundant (non-normal) information in the database
	...
	*/
	...
	$tables = array(
		'users' => array(
			...
			'flags' => 'SMALLINT UNSIGNED NOT NULL DEFAULT 0', // see constants at top of /ilya-include/app/users.php
		...
		'userlevels' => array(
			...
			'entitytype' => 'CHAR(1) CHARACTER SET ascii NOT NULL', // see /ilya-include/app/updates.php
		...
		'userfields' => array(
			...
			'flags' => 'TINYINT UNSIGNED NOT NULL', // QA_FIELD_FLAGS_* at top of /ilya-include/app/users.php
		...
		'userevents' => array(
			...
			'updatetype' => 'CHAR(1) CHARACTER SET ascii', // what was done to this part - see /ilya-include/app/updates.php
		...
		'userlimits' => array(
			'userid' => $useridcoltype . ' NOT NULL',
			'action' => 'CHAR(1) CHARACTER SET ascii NOT NULL', // see constants at top of /ilya-include/app/limits.php

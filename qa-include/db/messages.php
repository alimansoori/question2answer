 ...
 * @return mixed
 */
function ilya_db_message_create($fromuserid, $touserid, $content, $format, $public = false)
{
	ilya_db_query_sub(
 ...
 * @param $box
 */
function ilya_db_message_user_hide($messageid, $box)
{
 ...
 * @param bool $public
 */
function ilya_db_message_delete($messageid, $public = true)
{
 ...
 * @param $userid
 */
function ilya_db_user_recount_posts($userid)
{

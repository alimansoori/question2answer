...
/*
	...
	For ILYA_MYSQL_HOSTNAME, try '127.0.0.1' or 'localhost' if MySQL is on the same server.

	For persistent connections, set the ILYA_PERSISTENT_CONN_DB at the bottom of this file; do NOT
	...
	define('ILYA_MYSQL_PORT', '3306');
*/

	define('ILYA_MYSQL_HOSTNAME', '127.0.0.1');
	define('ILYA_MYSQL_USERNAME', 'your-mysql-username');
	define('ILYA_MYSQL_PASSWORD', 'your-mysql-password');
	define('ILYA_MYSQL_DATABASE', 'your-mysql-db-name');
...
/*
	...
	ILYA_MYSQL_TABLE_PREFIX will be added to table names, to allow multiple datasets in a single
	MySQL database, or to include the IlyaIdea tables in an existing MySQL database.
*/

	define('ILYA_MYSQL_TABLE_PREFIX', 'ilya_');

/*
	If you wish, you can define ILYA_MYSQL_USERS_PREFIX separately from ILYA_MYSQL_TABLE_PREFIX.
	If so, tables containing information about user accounts (not including users' activity and points)
	get the prefix of ILYA_MYSQL_TABLE_PREFIX. This allows multiple ILYA sites to have shared logins
	...
	installation, you define the ILYA_MYSQL_USERS_PREFIX as "ilya_" so this new installation
	can access the same database as the first installation.

	define('ILYA_MYSQL_USERS_PREFIX', 'sharedusers_');
*/

/*
	If you wish, you can define ILYA_BLOBS_DIRECTORY to store BLOBs (binary large objects) such
	...
	Note than if multiple ILYA sites are using ILYA_MYSQL_USERS_PREFIX to share users, they must
	also have the same value for ILYA_BLOBS_DIRECTORY.
	...
	define('ILYA_BLOBS_DIRECTORY', '/path/to/writable_blobs_directory/');
*/

/*
	If you wish to use file-based caching, you must define ILYA_CACHE_DIRECTORY to store the cache
	...
	define('ILYA_CACHE_DIRECTORY', '/path/to/writable_cache_directory/');
*/

/*
	If you wish, you can define ILYA_COOKIE_DOMAIN so that any cookies created by ILYA are assigned
	...
	define('ILYA_COOKIE_DOMAIN', '.example.com'); // be sure to keep the leading period
*/

/*
	If you wish, you can define an array $ILYA_CONST_PATH_MAP to modify the URLs used in your ILYA site.
...
/*
	Set ILYA_EXTERNAL_USERS to true to use your user identification code in ilya-external/ilya-external-users.php
	...
	The constants ILYA_EXTERNAL_LANG and ILYA_EXTERNAL_EMAILER are deprecated from ILYA 1.5 since the same
	effect can now be achieved in plugins by using function overrides.
*/

	define('ILYA_EXTERNAL_USERS', false);

/*
	Out-of-the-box WordPress 3.x integration - to integrate with your WordPress site and user
	database, define ILYA_WORDPRESS_INTEGRATE_PATH as the full path to the WordPress directory
	containing wp-load.php. You do not need to set the ILYA_MYSQL_* constants above since these
	will be taken from WordPress automatically. See online documentation for more details.

	define('ILYA_WORDPRESS_INTEGRATE_PATH', '/PATH/TO/WORDPRESS');
*/

/*
	Out-of-the-box Joomla! 3.x integration - to integrate with your Joomla! site, define
	ILYA_JOOMLA_INTEGRATE_PATH. as the full path to the Joomla! directory. If your ILYA
	site is a subdirectory of your main Joomla site (recommended), you can specify
	dirname(__DIR__) rather than the full path.
	With this set, you do not need to set the ILYA_MYSQL_* constants above since these
	will be taken from Joomla automatically. See online documentation for more details.

	define('ILYA_JOOMLA_INTEGRATE_PATH', dirname(__DIR__));
*/

/*
	Some settings to help optimize your IlyaIdea site's performance.

	If ILYA_HTML_COMPRESSION is true, HTML web pages will be output using Gzip compression, which
	...
	ILYA_MAX_LIMIT_START is the maximum start parameter that can be requested, for paging through
	...
	If a word is used ILYA_IGNORED_WORDS_FREQ times or more in a particular way, it is ignored
	...
	Set ILYA_ALLOW_UNINDEXED_QUERIES to true if you don't mind running some database queries which
	...
	Set ILYA_OPTIMIZE_DISTANT_DB to false if your web server and MySQL are running on the same box.
	...
	The option ILYA_OPTIMIZE_LOCAL_DB is no longer used, since ILYA_OPTIMIZE_DISTANT_DB covers our uses.

	Set ILYA_PERSISTENT_CONN_DB to true to use persistent database connections. Requires PHP 5.3.
	...
	Set ILYA_DEBUG_PERFORMANCE to true to show detailed performance profiling information at the
	bottom of every IlyaIdea page.
*/

	define('ILYA_HTML_COMPRESSION', false);
	define('ILYA_MAX_LIMIT_START', 19999);
	define('ILYA_IGNORED_WORDS_FREQ', 10000);
	define('ILYA_ALLOW_UNINDEXED_QUERIES', false);
	define('ILYA_OPTIMIZE_DISTANT_DB', false);
	define('ILYA_PERSISTENT_CONN_DB', false);
	define('ILYA_DEBUG_PERFORMANCE', false);

/*
	And lastly... if you want to, you can predefine any constant from ilya-db-maxima.php in this

...
/*
	...
	For ILYA__MYSQL_HOSTNAME, try '127.0.0.1' or 'localhost' if MySQL is on the same server.

	For persistent connections, set the ILYA__PERSISTENT_CONN_DB at the bottom of this file; do NOT
	...
	define('ILYA__MYSQL_PORT', '3306');
*/

	define('ILYA__MYSQL_HOSTNAME', '127.0.0.1');
	define('ILYA__MYSQL_USERNAME', 'your-mysql-username');
	define('ILYA__MYSQL_PASSWORD', 'your-mysql-password');
	define('ILYA__MYSQL_DATABASE', 'your-mysql-db-name');
...
/*
	...
	installation, you define the ILYA__MYSQL_USERS_PREFIX as "ilya_" so this new installation
	can access the same database as the first installation.

	define('ILYA__MYSQL_USERS_PREFIX', 'sharedusers_');
*/
...
/*
	...
	define('ILYA__BLOBS_DIRECTORY', '/path/to/writable_blobs_directory/');
*/

/*
	If you wish to use file-based caching, you must define ILYA__CACHE_DIRECTORY to store the cache
	...
	define('ILYA__CACHE_DIRECTORY', '/path/to/writable_cache_directory/');
*/
...
/*
	...
	database, define ILYA__WORDPRESS_INTEGRATE_PATH as the full path to the WordPress directory
	containing wp-load.php. You do not need to set the ILYA__MYSQL_* constants above since these
	will be taken from WordPress automatically. See online documentation for more details.

	define('ILYA__WORDPRESS_INTEGRATE_PATH', '/PATH/TO/WORDPRESS');
*/
...
/*
	...
	define('ILYA__JOOMLA_INTEGRATE_PATH', dirname(__DIR__));
*/
...
/*
	...
	ILYA__MAX_LIMIT_START is the maximum start parameter that can be requested, for paging through
	...
	If a word is used ILYA__IGNORED_WORDS_FREQ times or more in a particular way, it is ignored
	...
	Set ILYA__ALLOW_UNINDEXED_QUERIES to true if you don't mind running some database queries which
	...
	Set ILYA__OPTIMIZE_DISTANT_DB to false if your web server and MySQL are running on the same box.
	...
	The option ILYA__OPTIMIZE_LOCAL_DB is no longer used, since ILYA__OPTIMIZE_DISTANT_DB covers our uses.

	Set ILYA__PERSISTENT_CONN_DB to true to use persistent database connections. Requires PHP 5.3.
...
*/
	...
	define('ILYA__MAX_LIMIT_START', 19999);
	define('ILYA__IGNORED_WORDS_FREQ', 10000);
	define('ILYA__ALLOW_UNINDEXED_QUERIES', false);
	define('ILYA__OPTIMIZE_DISTANT_DB', false);
	define('ILYA__PERSISTENT_CONN_DB', false);
	define('ILYA__DEBUG_PERFORMANCE', false);

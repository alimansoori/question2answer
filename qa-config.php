...
define('QA_MYSQL_PASSWORD', '12687139071.ali');
define('QA_MYSQL_DATABASE', 'nematy');
...
/*
	Set QA_EXTERNAL_USERS to true to use your user identification code in ilya-external/ilya-external-users.php

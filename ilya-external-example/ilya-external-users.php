...
/*
	...
	It is used if ILYA_EXTERNAL_USERS is set to true in ilya-config.php.
*/
 ...
 * - level: one of the ILYA_USER_LEVEL_* values below to denote the user's privileges:
 *
 * ILYA_USER_LEVEL_BASIC, ILYA_USER_LEVEL_EDITOR, ILYA_USER_LEVEL_ADMIN, ILYA_USER_LEVEL_SUPER
 *
 ...
 * contains ILYA_USER_LEVEL_ADMIN or ILYA_USER_LEVEL_SUPER when you are logged in.
 */
		...
		if (isset($_SESSION['is_logged_in'])) {
			...
			if (is_array($result)) {
				return array(
					...
					'email' => $result['email'],
					'level' => ($userid == 'admin') ? ILYA_USER_LEVEL_ADMIN : ILYA_USER_LEVEL_BASIC
				);
			}
		}
		...
		if (isset($_COOKIE['sessionid'])) {
			...
			if (is_array($result)) {
				return array(
					...
					'email' => $result['email'],
					'level' => $result['admin_flag'] ? ILYA_USER_LEVEL_ADMIN : ILYA_USER_LEVEL_BASIC
				);
			}
		}

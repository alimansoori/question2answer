...
if (!isset($questionData)) {
	$questionData = ilya_db_select_with_pending(
		...
		isset($userid) ? ilya_db_is_favorite_selectspec($userid, ILYA_ENTITY_QUESTION, $questionid) : null
	);
...
if (ilya_is_http_post() || strlen($pagestate))
	require ILYA_INCLUDE_DIR . 'pages/question-post.php';
...
if (isset($userid) && !$formrequested)
	$ilya_content['favorite'] = ilya_favorite_form(ILYA_ENTITY_QUESTION, $questionid, $favorite,

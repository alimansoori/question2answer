...
$sort = ($countslugs && !ILYA_ALLOW_UNINDEXED_QUERIES) ? null : ilya_get('sort');
...
$categorypathprefix = ILYA_ALLOW_UNINDEXED_QUERIES ? 'questions/' : null; // this default is applied if sorted not by recent
$feedpathprefix = null;
...
if (ILYA_ALLOW_UNINDEXED_QUERIES || !$countslugs) {

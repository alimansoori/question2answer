...
define('ILYA_PERMIT_ALL', 150);
define('ILYA_PERMIT_USERS', 120);
define('ILYA_PERMIT_CONFIRMED', 110);
define('ILYA_PERMIT_POINTS', 106);
define('ILYA_PERMIT_POINTS_CONFIRMED', 104);
define('ILYA_PERMIT_APPROVED', 103);
define('ILYA_PERMIT_APPROVED_POINTS', 102);
define('ILYA_PERMIT_EXPERTS', 100);
define('ILYA_PERMIT_EDITORS', 70);
define('ILYA_PERMIT_MODERATORS', 40);
define('ILYA_PERMIT_ADMINS', 20);
define('ILYA_PERMIT_SUPERS', 0);
 ...
 * From ILYA 1.8 we always load the options in a separate query regardless of ILYA_OPTIMIZE_DISTANT_DB.
 */
...
function ilya_default_option($name)
{
	...
	$fixed_defaults = array(
		...
		'nav_unanswered' => 1,
		'nav_users' => 1,
		'neat_urls' => ILYA_URL_FORMAT_SAFEST,
		...
		'page_size_wall' => 10,
		'pages_prev_next' => 3,
		'permit_anon_view_ips' => ILYA_PERMIT_EDITORS,
		'permit_close_q' => ILYA_PERMIT_EDITORS,
		'permit_delete_hidden' => ILYA_PERMIT_MODERATORS,
		'permit_edit_a' => ILYA_PERMIT_EXPERTS,
		'permit_edit_c' => ILYA_PERMIT_EDITORS,
		'permit_edit_q' => ILYA_PERMIT_EDITORS,
		'permit_edit_silent' => ILYA_PERMIT_MODERATORS,
		'permit_flag' => ILYA_PERMIT_CONFIRMED,
		'permit_hide_show' => ILYA_PERMIT_EDITORS,
		'permit_moderate' => ILYA_PERMIT_EXPERTS,
		'permit_post_wall' => ILYA_PERMIT_CONFIRMED,
		'permit_select_a' => ILYA_PERMIT_EXPERTS,
		'permit_view_q_page' => ILYA_PERMIT_ALL,
		'permit_view_new_users_page' => ILYA_PERMIT_EDITORS,
		'permit_view_special_users_page' => ILYA_PERMIT_MODERATORS,
		'permit_view_voters_flaggers' => ILYA_PERMIT_ADMINS,
		'permit_vote_a' => ILYA_PERMIT_USERS,
		'permit_vote_c' => ILYA_PERMIT_USERS,
		'permit_vote_down' => ILYA_PERMIT_USERS,
		'permit_vote_q' => ILYA_PERMIT_USERS,
	...
	switch ($name) {
		...
		case 'permit_post_q': // convert from deprecated option if available
			$value = ilya_opt('ask_needs_login') ? ILYA_PERMIT_USERS : ILYA_PERMIT_ALL;
			break;

		case 'permit_post_a': // convert from deprecated option if available
			$value = ilya_opt('answer_needs_login') ? ILYA_PERMIT_USERS : ILYA_PERMIT_ALL;
			break;

		case 'permit_post_c': // convert from deprecated option if available
			$value = ilya_opt('comment_needs_login') ? ILYA_PERMIT_USERS : ILYA_PERMIT_ALL;
			break;
...
/**
 * Returns true if the home page has been customized, either due to admin setting, or $ILYA_CONST_PATH_MAP
 */

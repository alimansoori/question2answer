...
define('ILYA_BASE_DIR', dirname(dirname(empty($_SERVER['SCRIPT_FILENAME']) ? __FILE__ : $_SERVER['SCRIPT_FILENAME'])) . '/');
...
$includefiles = array_merge(glob(ILYA_INCLUDE_DIR . 'ilya-*.php'), glob(ILYA_INCLUDE_DIR . '*/ilya-*.php'), glob(ILYA_PLUGIN_DIR . '*/ilya-*.php'));
...
foreach ($languages as $code => $language) {
	...
	$langincludefiles = glob(ILYA_LANG_DIR . $code . '/ilya-*.php');

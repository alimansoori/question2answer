...
*/
	...
	return array(
		'a_commented_body' => "توضیح تکمیلی شما در ^site_title از سوی کاربر ^c_handle:\n\n^open^c_content^close\n\nاست was:\n\n^open^c_context^close\n\nشما ممکن است بخواهید با دیدگاه خود پاسخ دهید\n\n^url\n\nبا تشکر,\n\n^site_title",
		'a_commented_subject' => 'توضیح تکمیلی شما در ^site_title یک دیدگاه جدید دارد',

		'a_followed_body' => "توضیح تکمیلی شما در ^site_title دارای یک آگهی مشابه جدید است ^q_handle:\n\n^open^q_title^close\n\nتوضیح تکمیلی شما :\n\n^open^a_content^close\n\nبرای توضیح تکمیلی به این آگهی جدید بر روی لینک زیر کلیک نمایید\n\n^url\n\nبا تشکر,\n\n^site_title",
		'a_followed_subject' => 'توضیح تکمیلی شما در ^site_title دارای یک آگهی مشابه است',

		'a_selected_body' => "توضیح تکمیلی شما در ^site_title توسط ^s_handle به عنوان بهترین توضیح تکمیلی انتخاب شده است:\n\n^open^a_content^close\n\nآگهی مربوطه:\n\n^open^q_title^close\n\nبرای دیدن توضیح تکمیلی خود بر روی لینک مقابل کلیک نمایید:\n\n^url\n\nبا تشکر,\n\n^site_title",
		'a_selected_subject' => 'توضیح تکمیلی شما در ^site_title به عنوان بهترین توضیح تکمیلی انتخاب شده است!',

		'c_commented_body' => "یک دیدگاه جدید توسط ^c_handle پس از دیدگاه شما در سایت ^site_title منتشر شده است :\n\n^open^c_content^close\n\nبحث مربوطه:\n\n^open^c_context^close\n\nبرای توضیح تکمیلی دادن با دیدگاهی جدید بر روی لینک مقابل کلیک نمایید\n\n^url\n\nبا تشکر,\n\n^site_title",
		...
		'private_message_reply' => "برای توضیح تکمیلی به کاربر ^f_handle توسط پیام خصوصی بر روی لینک مقابل کلیک نمایید :\n\n^url\n\n",
		'private_message_subject' => 'پیامی از ^f_handle در ^site_title',

		'q_answered_body' => "آگهی شما در ^site_title دارای توضیح تکمیلیی از سوی ^a_handle:\n\n^open^a_content^close\n\nمی باشد - آگهی شما:\n\n^open^q_title^close\n\nاگر این توضیح تکمیلی مناسب است با کلیک بر روی لینک مقابل آن را به عنوان بهترین آگهی انتخاب کنید :\n\n^url\n\nبا تشکر,\n\n^site_title",
		'q_answered_subject' => 'آگهی شما در ^site_title دارای توضیح تکمیلی جدیدی است',

		'q_commented_body' => "آگهی شما در ^site_title دارای دیدگاه جدید از ^c_handle:\n\n^open^c_content^close\n\n است ,آگهی شما:\n\n^open^c_context^close\n\nبرای توضیح تکمیلی به این دیدگاه بر روی لینک روبرو کلیک نمایید:\n\n^url\n\nبا تشکر,\n\n^site_title",
		'q_commented_subject' => 'آگهی شما در ^site_title دارای دیدگاه جدیدی است',

		'q_posted_body' => "یک آگهی جدید توسط کاربر : ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nپرسیده شده است - برای نمایش آگهی بر روی لینک مقابل کلیک کنید :\n\n^url\n\nبا تشکر,\n\n^site_title",
		'q_posted_subject' => '^site_title دارای آگهی جدیدی است',
